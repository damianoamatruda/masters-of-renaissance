...
public class MainMenuState extends CliController {
    ...
    public void render() {
        ...
        entries.put('2', new Menu.Entry("Play Online", cli1 -> cli1.setController(new PlayOnlineState())));
        entries.put('O', new Menu.Entry("Options...", cli1 -> cli1.setController(new OptionsState())));
    ...
    private void playOffline(Cli cli) {
        ...
        cli.setController(new InputNicknameState("Play Offline"));
    }
}
