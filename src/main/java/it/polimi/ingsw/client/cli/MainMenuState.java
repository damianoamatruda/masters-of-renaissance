...
public class MainMenuState extends CliState {
    ...
    private void renderMainMenu(Cli cli) {
        ...
        entries.put('S', new Menu.Entry("Play Offline", cli1 -> cli.setState(new PlayOfflineState())));
        entries.put('M', new Menu.Entry("Play Online", cli1 -> cli.setState(new PlayOnlineState())));
