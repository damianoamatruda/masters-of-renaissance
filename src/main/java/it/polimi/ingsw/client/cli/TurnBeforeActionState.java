...
public class TurnBeforeActionState extends CliTurnState {
    ...
    public void render() {
        ...
        entries.put('2', new Menu.Entry("Buy a Development Card", cli1 -> cli1.setState(new BuyDevelopmentCardState(this))));
        entries.put('3', new Menu.Entry("Activate Productions", cli1 -> cli1.setState(new ActivateProductionsState(this))));
